...
/// @brief rendererre másolja a nehézséget jelzõ és állító szöveget
/// @param renderer menü rendererje
/// @param font használt font
/// @param hardmode be van e kapcsolva a nehéz játékmód
/// @return 0 ha sikeres
...
/// @brief leelenõrzi le lett -e nyomva a gomb
/// @param hard_pos gomb pozíciója
